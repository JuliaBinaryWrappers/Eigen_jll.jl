...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Eigen_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("bc6bbf8a-a594-5541-9c57-10b0d0312c70"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Eigen", artifacts_toml) for e in artifacts["Eigen"]]
...
if best_platform === nothing
    @debug("Unable to load Eigen; unsupported platform $(triplet(platform_key_abi()))")
else
